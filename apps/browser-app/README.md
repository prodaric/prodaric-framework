...
**Idioma:** La interfaz está en **español** por defecto (`defaultLocale: "es"`). Se usa el paquete `@coderic/theia-l10n` para que Theia acepte las traducciones. Si aún ves la UI en inglés: borra los datos del sitio para localhost:3000 (DevTools → Application → Clear site data) o abre en ventana de incógnito; también puedes usar «Configurar idioma de visualización» (Ctrl+Shift+P) y elegir Español.
